...
public class CadCandidatos extends javax.swing.JFrame {
    ...
    public CadCandidatos() throws SQLException {
        ...
        try {
            cbCombos = new Combos(jcbBairro);
            cbCombos.preencheCombo("SELECT id, nome FROM bairros ORDER BY nome");
        } catch (Exception ex) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            ...
            if (retorno) {
                ...
                objCandidato.setDt_nascimento(data);
    ...
    private boolean validarDados() {
        ...
        if (!txtEmail.getText().equals("")) {
            if (!Validacao.validarEmail(txtEmail.getText())) {
                CaixaDeDialogo.obterinstancia().exibirMensagem("Informe um e-mail válido!", 'a');
                return false;
            }
        }
    ...
    private void preencherCampos(Candidato objeto) {
        try {
            ...
            String data_dma = Formatacao.ajustaDataDMA(objeto.getDt_nascimento());
            txtDataNasc.setText(data_dma);
            txtEmail.setText(objeto.getEmail());
            txtTelefone.setText(objeto.getTelefone());
            cbCombos.SetaComboBox(String.valueOf(objeto.getId_bairro()));
            atualizarTabela();
